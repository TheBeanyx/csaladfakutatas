...
export function SiteFooter() {
  return (
    <footer className="mt-24 border-t border-border bg-primary text-primary-foreground">
      <div className="container-prose py-12 grid md:grid-cols-3 gap-8 text-sm">
        <div>
          <div className="font-serif text-2xl text-gold">Csányi Levéltár</div>
        ...
        <div>
          <div className="text-gold uppercase tracking-wider text-xs mb-3">Elérhetőség</div>
          <ul className="space-y-1.5 text-primary-foreground/80">
            <li>admin@csaladfakutatas.hu</li>
            <li>1051 Budapest, Levéltár u. 12.</li>
      ...
      <div className="border-t border-primary-foreground/10 py-4 text-center text-xs text-primary-foreground/60">
        © {new Date().getFullYear()} Csányi Levéltár — Minden jog fenntartva.
      </div>
    </footer>
  );
}
